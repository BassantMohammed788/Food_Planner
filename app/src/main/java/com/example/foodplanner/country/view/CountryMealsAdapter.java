...
import com.example.foodplanner.category.view.CategoryFragmentDirections;
import com.example.foodplanner.category.view.OnCategoriesClickListenter;
...
public class CountryMealsAdapter extends RecyclerView.Adapter<CountryMealsAdapter.ViewHolder> {
    ...
    public CountryMealsAdapter(Context context, List<Meal> values, OnCountryClickListener listener) {
    ...
    @NonNull
    @Override
    public CountryMealsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup recyclerView, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CountryMealsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CountryFragmentDirections.ActionCountryFragmentToMealDetailsFragment action =
                        CountryFragmentDirections.actionCountryFragmentToMealDetailsFragment(values.get(position).getStrMeal());
