...
import com.example.foodplanner.home.view.HomeFragmentDirections.ActionHomeFragmentToCategoryFragment;
...
public class AllCatigoriesAdapter extends RecyclerView.Adapter<AllCatigoriesAdapter.ViewHolder> {
    ...
    public AllCatigoriesAdapter(Context context, List <Category> values, OnHomeClickListener listener) {
    ...
    @NonNull
    @Override
    public AllCatigoriesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup recyclerView, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AllCatigoriesAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActionHomeFragmentToCategoryFragment action=
                        HomeFragmentDirections.actionHomeFragmentToCategoryFragment(values.get(position).getStrCategory());
